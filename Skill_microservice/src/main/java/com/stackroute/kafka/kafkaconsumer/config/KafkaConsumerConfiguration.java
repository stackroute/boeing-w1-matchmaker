...
public class KafkaConsumerConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, Skill> userConsumerFactory() {
        Map<String, Object> config = new HashMap<>();
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(),
                new JsonDeserializer<>(Skill.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Skill> userKafkaListenerFactory() {
