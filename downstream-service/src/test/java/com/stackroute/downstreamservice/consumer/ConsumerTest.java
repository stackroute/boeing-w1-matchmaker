/*package com.stackroute.downstreamservice.consumer;
...
import com.stackroute.downstreamservice.listener.DownStreamListener;
...
public class ConsumerTest {
	...
	@Autowired
	public DownStreamListener DownStreamListener;
	...
	public void testReceive() throws Exception {
		...
		DownStreamListener.getLatch().await(10000, TimeUnit.MILLISECONDS);

		// check that the message was received
		assertThat(DownStreamListener.getLatch().getCount()).isEqualTo(0);
	}
